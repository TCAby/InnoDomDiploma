...
urlpatterns = [
    ...
    path('surveys/questions/edit/<int:id>/', views.add_question, name="add-question"),  # ToDo
    ...
    re_path(r'^admin/survey/question/(?P<questionnaire_id>\d+)/change/$', views.add_question),
